        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Data Mahasiswa Seleksi Mandiri</div>
                </div>
            </div>
            <h2 class="section-title">Preview</h2>
            <p class="section-lead">
                Preview data mahasiswa seleksi mandiri dan kuota program studi
            </p>
            <div id="">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" >
                                ...
                                id="modal-1"><i class="fa-solid fa-filter"></i>&nbsp; Filter Data</button>
                            </div>
                            <div>
                                <div class="card-body">
