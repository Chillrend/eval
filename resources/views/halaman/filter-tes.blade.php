...
@section('main')
<div class="main-content" id="main-content" url="{{route('api_tahunFilterTes')}}">
        ...
        <div class="card" id="headfilter" hidden>
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center col-12 col-xl-3 col-lg-4 col-md-4 col-sm-12 my-1">
                    ...
                    <select class="form-control" name="tahun_terdaftar" id="tahun_terdaftar" onchange="getPend()" url="{{route('api_pendFilterTes')}}">
                ...
                <div class="d-flex align-items-center col-12 col-xl-3 col-lg-4 col-md-4 col-sm-12 my-1">
                    ...
                    <select class="form-control" name="pendidikan" id="pendidikan" onchange="getKolom()" url="{{route('api_kolomFilterTes')}}" disabled>
        ...
        <div class="card" id="formfilter" hidden>
            <form id="">
                ...
                <div class="card-footer text-right">
                    <button type="button" id="btnFilter" class="btn btn-primary" onclick="kirimFilter()" url="{{route('api_renderFilterTes')}}">Filter</button>
                </div>
            </form>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-right row">
                                ...
                                <button class="btn btn-lg btn-success mx-1" id="saveBtn" onclick="saveFilter()" url="{{route('saveFilterTes')}}">
