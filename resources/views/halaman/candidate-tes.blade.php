            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="">
                            <form url="{{route('api_importCanTes')}}" id="form-candidate">
                                <div class="card-body">
                                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-right row">
                                <button class="btn btn-lg btn-warning mx-1" id="cancelbtn" url="{{route('api_cancelCanTes')}}" onclick="cancel()">
                                    <h6 class="my-0">Cancel</h6>
                                </button>
                                <button class="btn btn-lg btn-success mx-1" id="savebtn" url="{{route('api_saveCanTes')}}" onclick="save()">
