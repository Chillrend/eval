...
@section('main')
<div class="main-content" id="main-content" url="{{route('api_tahunFilterPres')}}">
    <section class="section">
        <div class="section-header">
            <h1>Form Filter Calon Mahasiswa - Tahap Prestasi</h1>
        </div>
        ...
        <div class="card" id="headfilter" hidden>
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center col-12 col-xl-3 col-lg-4 col-md-4 col-sm-12 my-1">
                    ...
                    <select class="form-control" name="tahun_terdaftar" id="tahun_terdaftar" onchange="getPend()" url="{{route('api_pendFilterPres')}}">
                ...
                <div class="d-flex align-items-center col-12 col-xl-3 col-lg-4 col-md-4 col-sm-12 my-1">
                    ...
                    <select class="form-control" name="pendidikan" id="pendidikan" onchange="getKolom()" url="{{route('api_kolomFilterPres')}}" disabled>
        ...
        <div class="card" id="formfilter" hidden>
            <form id="">
                ...
                <div class="card-footer text-right">
                    <button type="button" id="btnFilter" class="btn btn-primary" onclick="kirimFilter()" url="{{route('api_renderFilterPres')}}">Filter</button>
                </div>
            </form>
        </div>
...
<script src="../../js/filter-prestasi.js"></script>
@endpush