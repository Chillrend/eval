...
@section('main')
<div class="main-content" id="main-content" url="{{route('api_dashboard')}}">
        ...
        <div class="section-body">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body" id="total-candidates">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body" id="total-prestasi">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body" id="total-tes">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body" id="total-mandiri">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="my-2">Statistik Pendaftar</h4>
                        </div>
                        <div class="card-body" id="chart-statistik">
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="my-2">Progres Kegiatan</h4>
                        </div>
                        <div class="card-body" id="chart-progress">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="data-tab" data-toggle="tab" href="#data" role="tab" aria-controls="data" aria-selected="true">Data Mahasiswa</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="prodi-tab" data-toggle="tab" href="#prodi" role="tab" aria-controls="prodi" aria-selected="false">Program Studi</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="bobot-tab" data-toggle="tab" href="#bobot" role="tab" aria-controls="bobot" aria-selected="false">Pembobotan</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-sm-12 col-md-8">
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <div class="tab-pane fade" id="bobot" role="tabpanel" aria-labelledby="bobot-tab">
                                            <div class="card-body">
