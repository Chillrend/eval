...
@section('main')
<div class="main-content" id="main-content" url="{{ route('api_renderProPres') }}">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <div class="">
                                <table class="table-hover table-md table display nowrap" id="table-prodi-pres" style="width: 100%" url="{{ route('api_deleteProPres') }}">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
    ...
    <section id="prodi-prestasi-edit" hidden>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div id="edit-prodi-pres" url="{{ route('api_editProPres') }}">
                    @csrf
                        <div class="card-body">
    ...
    <form class="modal-part" id="modal-add-prodi" action="{{route('addProdiPres')}}" method="post">
        @csrf
...
<script src="../../js/prodi-pres.js"></script>
